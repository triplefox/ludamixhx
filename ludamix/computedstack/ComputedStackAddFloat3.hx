...
class ComputedStackAddFloat3 {
	
	// with "add" we emit the sum of the stack and push a default
	
	public var d = new GrowVector3<Float>(3);
	
	public var dirty : Bool = true;
	public var computed = new Vector<Float>(3);
	public var default_data = new Vector<Float>(3);
	...
	public inline function emit(buf : GrowVector3<Float>) {
		if (dirty) recompute();
